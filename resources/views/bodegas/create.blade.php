    ...
    <div class="container">
        ...
        <form action="{{ route('bodegas.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <table class="table" id="inventario_actual_table">
                    <thead>
                        <tr>
                            <th>Proveedor ID</th>
                            <th>Product ID</th>
                            <th>Cantidad</th>
                            <th><button type="button" class="btn btn-sm btn-primary" onclick="addRow()">Agregar Producto</button></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
            ...
            <div class="form-group">
                ...
                <table class="table" id="gerentes_table">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Nombre</th>
                            <th>Email</th>
                            <th>Teléfono</th>
                            <th><button type="button" class="btn btn-sm btn-primary" onclick="addGerente()">Agregar Gerente</button></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
            ...
            <div class="form-group">
                ...
                <table class="table" id="historial_envios_table">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Fecha</th>
                            ...
                            <th><button type="button" class="btn btn-sm btn-primary" onclick="addEnvio()">Agregar Envío</button></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
